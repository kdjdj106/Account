...
class TransactionServiceTest {
    ...
    @DisplayName("해당계좌 없음 - 잔액 사용취소 실패")
    @Test
    ...
    @DisplayName("해당거래 없음 - 잔액 사용취소 실패")
    @Test
    ...
    @DisplayName("거래와 계좌가 매칭실패 - 잔액 사용취소 실패")
    @Test
    ...
    @DisplayName("거래금액과 취소금액이 다름 - 잔액 사용취소 실패")
    @Test
    ...
    @DisplayName("취소는 1년까지만 가능 - 잔액 사용취소 실패")
    @Test
